    ...
    <div className="sticky top-0 z-20 bg-secondary border-b border-border backdrop-blur-md">
      <div className="flex items-center justify-between px-6 py-3 border-b border-border">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={onToday}
            className="px-4 py-2 bg-nav-active-bg hover:opacity-90 text-nav-active-fg rounded-lg text-sm font-medium transition-all duration-200 hover:scale-105 active:scale-95"
          >
            Сегодня
          </button>
          <button
