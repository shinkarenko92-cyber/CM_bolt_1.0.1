...
const COLORS = ['hsl(var(--brand))', '#3b82f6', '#8b5cf6', '#f59e0b', '#ef4444', '#22c55e'];
                  ...
                  <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
                    <PieChart>
                      ...
                      <RechartsTooltip
                        ...
                        formatter={(value: any) => value !== undefined ? [`${formatCurrency(value)} ₽`, t('analytics.revenue')] : ['', '']}
                      />
                    </PieChart>
                  </ResponsiveContainer>
                </div>
          ...
          <div className="w-full min-w-0" style={{ minHeight: CHART_HEIGHT }}>
            <ResponsiveContainer width="100%" height={CHART_HEIGHT}>
              <LineChart data={bookingsDynamicsData}>
                ...
                <Line yAxisId="right" type="monotone" dataKey="revenue" name={t('analytics.revenue')} stroke="hsl(var(--brand))" strokeWidth={2} dot={{ fill: 'hsl(var(--brand))' }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
          </CardContent>
